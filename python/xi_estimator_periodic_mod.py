...
# PARAMETERS
Dname = '../den_files/mass_cuts_nd1_00_z0_fixedAmp_002.txt'
...
tmpDD=DDsmu(1,nthreads,binfile,mu_max,nmu_bins,dX,dY,dZ,weights1=dW,periodic=True, boxsize=1000.,verbose=True,weight_type='pair_product')

print('anto aca estas---------------------------')
